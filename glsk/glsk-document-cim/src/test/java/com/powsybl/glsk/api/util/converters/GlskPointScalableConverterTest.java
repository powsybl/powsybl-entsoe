...
class GlskPointScalableConverterTest {
    ...
    void testConvertGlskPointToScalableB45MeritOrder() {
        ...
        Assertions.assertTrue(DoubleMath.fuzzyEquals(6, done, 0.0001));
        ...
        Assertions.assertTrue(DoubleMath.fuzzyEquals(2001., generator1.getTargetP(), 0.0001));
        Assertions.assertTrue(DoubleMath.fuzzyEquals(2002., generator2.getTargetP(), 0.0001));
        done = scalable.scale(testNetwork, -3000.0);
        Assertions.assertTrue(DoubleMath.fuzzyEquals(-3000., done, 0.0001));
        Assertions.assertTrue(DoubleMath.fuzzyEquals(0., generator1.getTargetP(), 0.0001));
        Assertions.assertTrue(DoubleMath.fuzzyEquals(1003., generator2.getTargetP(), 0.0001));
    ...
    void testConvertGlskPointToScalableB42Country() {
        ...
        double done = scalable.scale(testNetwork, 100.0);
        Assertions.assertTrue(DoubleMath.fuzzyEquals(100, done, 0.0001));
    }
