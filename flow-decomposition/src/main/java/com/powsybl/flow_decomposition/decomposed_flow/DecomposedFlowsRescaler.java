 ...
 */
package com.powsybl.flow_decomposition.decomposed_flow;
 ...
 */
public class DecomposedFlowsRescaler {
    ...
    public Map<String, DecomposedFlow> rescale(Map<String, DecomposedFlow> decomposedFlowMap) {
