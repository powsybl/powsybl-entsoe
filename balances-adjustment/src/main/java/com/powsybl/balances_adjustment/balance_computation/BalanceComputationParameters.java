...
public class BalanceComputationParameters extends AbstractExtendable<BalanceComputationParameters> {
    ...
    public static final boolean DEFAULT_SKIP_LOAD_FLOW = false;
    ...
    /**
     * Skip load flow computation and perform only one iteration
     */
    private boolean skipLoadFlow;

    /**
     * Constructor with default parameters
     */
    public BalanceComputationParameters() {
        this(DEFAULT_THRESHOLD_NET_POSITION, DEFAULT_MAX_NUMBER_ITERATIONS, DEFAULT_MISMATCH_MODE, DEFAULT_SKIP_LOAD_FLOW);
    }
     ...
     * @param skipLoadFlow Skip load flow computation and perform only one iteration
     */
    public BalanceComputationParameters(double threshold, int maxNumberIterations, MismatchMode mismatchMode, boolean skipLoadFlow) {
        ...
        this.skipLoadFlow = skipLoadFlow;
    }
    ...
    public BalanceComputationParameters(double threshold, int maxNumberIterations, MismatchMode mismatchMode) {
        this(threshold, maxNumberIterations, mismatchMode, DEFAULT_SKIP_LOAD_FLOW);
    }
    ...
    public BalanceComputationParameters(double threshold, int maxNumberIterations) {
        this(threshold, maxNumberIterations, DEFAULT_MISMATCH_MODE, DEFAULT_SKIP_LOAD_FLOW);
    }
    ...
    public boolean isSkipLoadFlow() {
        return skipLoadFlow;
    }

    public BalanceComputationParameters setSkipLoadFlow(boolean skipLoadFlow) {
        this.skipLoadFlow = skipLoadFlow;
        return this;
    }
    ...
    public static BalanceComputationParameters load(PlatformConfig platformConfig) {
        ...
        platformConfig.getOptionalModuleConfig("balance-computation-parameters").ifPresent(config -> parameters
                ...
                .setSkipLoadFlow(config.getBooleanProperty("skipLoadFlow", DEFAULT_SKIP_LOAD_FLOW)));
