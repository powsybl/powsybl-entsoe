    ...
    public BalanceComputationParameters deserialize(JsonParser parser, DeserializationContext deserializationContext, BalanceComputationParameters parameters) throws IOException {
        ...
        while (parser.nextToken() != JsonToken.END_OBJECT) {
            switch (parser.getCurrentName()) {
                ...
                case "skipLoadFlow":
                    JsonUtil.assertGreaterOrEqualThanReferenceVersion(CONTEXT_NAME, "Tag: skipLoadFlow", version, "1.2");
                    parser.nextToken();
                    parameters.setSkipLoadFlow(parser.readValueAs(boolean.class));
                    break;
