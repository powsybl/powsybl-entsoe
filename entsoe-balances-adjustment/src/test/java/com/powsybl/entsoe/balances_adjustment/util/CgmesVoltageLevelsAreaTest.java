...
public class CgmesVoltageLevelsAreaTest {
    ...
    public void test() {
        ...
        NetworkAreaFactory factory = new CgmesVoltageLevelsAreaFactory(cgmesArea, Collections.emptyList(),
                Arrays.asList("_d0486169-2205-40b2-895e-b672ecb9e5fc",
        ...
        double real = -network.getDanglingLine("_78736387-5f60-4832-b3fe-d50daf81b0a6").getBoundary().getP() - network.getDanglingLine("_17086487-56ba-4979-b8de-064025a6b4da").getBoundary().getP()
                - network.getDanglingLine("_b18cd1aa-7808-49b9-a7cf-605eaf07b006").getBoundary().getP() + lineFlow + tieLineFlow;
